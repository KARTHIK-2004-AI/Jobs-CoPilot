...
def _run_tailor(min_score: int = 7, validation_mode: str = "normal", limit: int = 20) -> dict:
...
def _run_cover(min_score: int = 7, validation_mode: str = "normal", limit: int = 20) -> dict:
